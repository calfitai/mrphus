...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black to-gray-900" aria-labelledby="nano-banana-heading">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {categories.filter(cat => cat.id >= '27' && cat.id <= '32').map((category) => (
              <div
                key={category.id}
                className="bg-gradient-to-br from-[#ff5757]/10 to-[#ff8a8a]/5 backdrop-blur-sm rounded-2xl p-6 border border-[#ff5757]/20 hover:border-[#ff5757]/40 transition-all group cursor-pointer"
              >
                <div className="aspect-square mb-4 rounded-lg overflow-hidden">
                  <img 
                    src={category.image} 
                    alt={`${category.title} - Nano Banana AI feature`}
                    className="w-full h-full object-cover object-center group-hover:scale-105 transition-transform duration-300"
                    loading="eager"
                    fetchPriority="high"
                  />
            ...
            <div className="bg-gradient-to-r from-[#ff5757]/20 to-[#ff8a8a]/20 rounded-2xl p-8 border border-[#ff5757]/30">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Maintain the same character across multiple scenes and stories</p>
                </div>
                <div>
                  <h4 className="font-semibold text-[#ff5757] mb-2">Multi-Turn Editing</h4>
                  <p className="text-gray-400 text-sm">Build images step by step with iterative improvements</p>
                </div>
                <div>
                  <h4 className="font-semibold text-[#ff5757] mb-2">Natural Language</h4>
                  <p className="text-gray-400 text-sm">Edit images using simple, everyday language commands</p>
                </div>
              </div>
            </div>
          </div>
