        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="text-center mb-12">
            ...
            <div className="flex justify-center space-x-6 mb-8">
              <a href="#" className="w-12 h-12 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-[#ff5757]/20 transition-all group">
                <svg className="w-6 h-6 text-white group-hover:text-[#ff5757]" fill="currentColor" viewBox="0 0 24 24">
